    ...
    >
      <div className="mx-auto flex w-full max-w-7xl flex-col gap-16 lg:gap-20">
        <div className="max-w-2xl">
          ...
          <h2 className="font-[family-name:var(--font-display)] text-4xl font-semibold leading-[1] tracking-[-0.05em] text-[var(--color-text)] sm:text-5xl lg:text-[44px] lg:leading-[52px]">
        ...
        <div className="flex flex-col gap-8 lg:gap-12">
          <div className="grid items-center gap-6 lg:grid-cols-[0.9fr_1.1fr] lg:gap-10">
            ...
            <motion.div
              className="order-1 overflow-hidden rounded-[var(--radius-lg)] bg-[var(--color-sand)] shadow-[0_24px_60px_var(--color-shadow)] lg:order-2"
              initial={{ opacity: 0, x: 24 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ ...rowTransition, delay: 0.05 }}
              viewport={{ once: true, amount: 0.35 }}
            >
              <ProjectImage id="feature_1" className="h-full min-h-[320px] w-full object-cover" />
            </motion.div>
          </div>

          <div className="grid items-center gap-6 lg:grid-cols-[1.05fr_0.95fr] lg:gap-10">
            <motion.div
              className="overflow-hidden rounded-[var(--radius-lg)] bg-[var(--color-surface)] shadow-[0_24px_60px_var(--color-shadow)]"
              initial={{ opacity: 0, x: -24 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ ...rowTransition, delay: 0.02 }}
              viewport={{ once: true, amount: 0.35 }}
            >
              <ProjectImage id="feature_2" className="h-full min-h-[320px] w-full object-cover" />
            </motion.div>
            <motion.div
              className="flex flex-col gap-4 rounded-[var(--radius-lg)] bg-[var(--color-surface)] p-8 shadow-[0_24px_60px_var(--color-shadow)]"
              initial={{ opacity: 0, x: 24 }}
              whileInView={{ opacity: 1, x: 0 }}
              transition={{ ...rowTransition, delay: 0.08 }}
              viewport={{ once: true, amount: 0.35 }}
            >
              <h3 className="font-[family-name:var(--font-body)] text-2xl font-semibold leading-8 text-[var(--color-text)]">
          ...
          <div className="grid items-center gap-6 lg:grid-cols-[0.88fr_1.12fr] lg:gap-10">
            <motion.div
              className="flex flex-col gap-4 rounded-[var(--radius-lg)] bg-[var(--color-sand)] p-8 shadow-[0_24px_60px_var(--color-shadow)]"
              initial={{ opacity: 0, x: -24 }}
              whileInView={{ opacity: 1, x: 0 }}
            ...
            <motion.div
              ...
              viewport={{ once: true, amount: 0.35 }}
            >
              <ProjectImage id="feature_3" className="h-full min-h-[320px] w-full object-cover" />
            </motion.div>
          </div>
        </div>
      </div>
